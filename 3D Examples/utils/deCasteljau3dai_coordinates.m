function [bez,nodes,dimBasis,newBasisIndex] = deCasteljau3dai_coordinates(Ce,knotU1,knotU2,knotV1,knotV2,knotW1,knotW2,p,q,r,newVert,knotUl,knotUr,knotVd,knotVu,knotWb,knotWt,elmIn,dimBasis)
...
%add in the new basis functions define corners indices
reg = getRegionIndices3D( p,q,r );

[newBasisSet,dimBasis,newBasisIndex] = newBasisIndices3D_coordinates(newVert,elmIn,p,q,r,dimBasis,reg);
