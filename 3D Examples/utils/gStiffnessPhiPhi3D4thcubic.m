function [stiffPhiPhi,RHSPhi,fenerg] = gStiffnessPhiPhi3D4thcubic(numberElements,sctrxElem,sizeBasis,dgdxCell,d2gdx2Cell,shapeCell,volumeCell,Fract,Mater,geometry,fenerg,solU,solPhi)
