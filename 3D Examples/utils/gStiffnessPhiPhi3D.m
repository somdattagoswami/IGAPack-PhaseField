function [stiffPhiPhi,RHSPhi,fenerg] = gStiffnessPhiPhi3D(numberElements,sctrxElem,sizeBasis,dgdxCell,shapeCell,volumeCell,Fract,Mater,geometry,fenerg,tdisp)
