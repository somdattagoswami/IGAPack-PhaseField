...
% Input File for cube under tension
...
geometry.W = 0.2; % Width of the plate in the Y direction
geometry.H = 1; % Height of the plate in Z Direction
...
Fract.constl = 1/16; % L0 : Length parameter which controls the spread of the damage
...
Integ.dfacto1 = 5e-3; % Displacement increment per time steps upto numStepsLimit
Integ.dfacto2 = 5e-4; % Displacement increment per time steps
Integ.numStepsLimit = 15;
