% Script for a two dimensional cantilever plate subjected to tension
...
Input = @() Input_cantilever;
PF.Geometry = @(geometry)initMeshTensile(geometry);
PF.Boundary = @(PHTelem,geometry,controlPts)initialBC_cantilever(PHTelem,geometry,controlPts);
