function [stiffkPhiPhi,Phi] = gStiffnessPhiPhi4th_bimaterial(PHTelem,sizeBasis,numberElements,dgdx,d2gdx2,shape,Fract,Mater,volume,fenerg,geometry,gaussCord)
